...
CKPT_ARGS=(
    ...
    --load ${MODEL_DIR}/Qwen3-8B-Base_sft_openthoughts3_4_r3/
    --save ${MODEL_DIR}/Qwen3-8B-Base_sft_openthoughts3_4_r3/
    --save-interval 300
)

SFT_ARGS=(
    --rollout-function-path slime.rollout.sft_rollout.generate_rollout
    --prompt-data /shared/dev/scottcyc/data/openthoughts3_math_10k_4_qwq_wthink.jsonl
    --input-key messages
