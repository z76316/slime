...
CKPT_ARGS=(
    ...
    --load ${MODEL_DIR}/Qwen3-8B-Base_sft_openthoughts3_glm106b_2_r2/
    --save ${MODEL_DIR}/Qwen3-8B-Base_sft_openthoughts3_glm106b_2_r2/
    --save-interval 150
)

SFT_ARGS=(
    --rollout-function-path slime.rollout.sft_rollout.generate_rollout
    --prompt-data /shared/dev/scottcyc/data/openthoughts3_math_10k_2_glm106b.jsonl
    --input-key messages
