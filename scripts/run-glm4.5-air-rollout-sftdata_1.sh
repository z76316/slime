...
echo "=== Starting single-node Ray on this pod ==="
ray start --head --node-ip-address "$MY_IP" --port=${RAY_PORT_NUMBER} --num-gpus 8 \
...
PROMPT_DATA="/shared/dev/scottcyc/data/openthoughts3_math_10k_prompts_slime_1.jsonl"
...
ROLLOUT_ARGS=(
   ...
   --dump-details $DATA_DIR/GLM/glm106b_rollout_debug-0-1
   --debug-rollout-only
)
...
WANDB_KEY="3216efad078e7c21e4b785ef4db3fc2fe2b04996"
WANDB_ARGS=(
   --use-wandb
